...
AForm	*Intern::makeForm(std::string formName, std::string target)
{
	...
	FormMaker	maker[3] = {makeRobotomyRequestForm, makePresidentialPardonForm, makeShrubberyCreationForm};
	std::string	FormNames[3] = {"roboto myRequest", "presidential pardon", "shrubbery creation"};
	AForm*		form = NULL;
